...
export const getUpcomingSurveys = async (user?: UserSession | null) => {
    try {
        ...
        console.log('upcoming-surveys returned my gee: ', response?.data);

        return response?.data.results;
    } catch (error) {
        console.error('Error fetching all upcoming-surveys:', error);
        return null;
    }
};