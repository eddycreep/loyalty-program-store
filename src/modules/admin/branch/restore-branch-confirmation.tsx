...
export const RestoreBranchConfirmation = ({ isOpen, onClose, branchID, onSuccess }: any) => {
    ...
    const restoreBranch = async () => {
        try{
            const url = `branch/restore-branch/${branchID}`
            ...
            toast.error('Branch Not Restored', {
        ...
        <div className="h-screen fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="relative bg-white rounded-lg shadow-lg p-6 w-[450px]">
                ...
                <div className="flex justify-end space-x-2">
                    ...
                    <Button onClick={() => restoreBranch() } className="bg-red text-white border-red hover:bg-rose-300 hover:border-rose-300 h-8">
                        Confirm
                    </Button>
                </div>
            </div>
