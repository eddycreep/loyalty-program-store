        ...
        <div className="w-full h-full flex justify-between px-4 py-4 gap-2 rounded-lg">
            <div className='w-full h-screen flex flex-col px-4 py-4 gap-4 rounded-lg overflow-y-auto m2b-4'>
                ...
                <TabsContent value="customer-engagement" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('members')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'members'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Active Members</button>
                            <button onClick={() => setCurrentTab('enrollment')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'enrollment'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Enrollment Rate</button>
                            <button onClick={() => setCurrentTab('retention')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'retention'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Retention Rate</button>
                            <button onClick={() => setCurrentTab('redemption')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'redemption'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Redemption Rate</button>
                        </div>
                    </div>
                ...
                <TabsContent value="financial" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('revenue')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'revenue'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Revenue</button>
                            ...
                            <button onClick={() => setCurrentTab('combined')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'combined'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Combined Specials</button>
                            <button onClick={() => setCurrentTab('discountRevenue')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'discountRevenue'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Discounted Revenue</button>
                        </div>
                    </div>
                ...
                <TabsContent value="redemption" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('firstRedemtion')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'firstRedemtion'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Avg. First Redemption</button>
                            <button onClick={() => setCurrentTab('redemptionFrequency')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'redemptionFrequency'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Redemption Frequency</button>
                            <button onClick={() => setCurrentTab('usedSpecials')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'usedSpecials'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Unused Specials</button>
                        </div>
                    </div>
                ...
                <TabsContent value="satisfaction" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('satisfaction')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'satisfaction'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Customer Satisfaction</button>
                            <button onClick={() => setCurrentTab('avgTransaction')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'avgTransaction'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Avg. Spend Transaction</button>
                ...
                <TabsContent value="effectiveness" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('memberConversion')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'memberConversion'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Member Conversion</button>
                            <button onClick={() => setCurrentTab('promotionalImpact')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'promotionalImpact'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Promotional Impact</button>
                        </div>
                    </div>
                ...
                <TabsContent value="performance" className="space-y-4">
                    <div className="pl-2">
                        <div className="w-full sm:flex justify-start md:gap-2 flex-wrap md:flex justify-start md:gap-4 flex-wrap lg:flex items-center">
                            <button onClick={() => setCurrentTab('topPerforming')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'topPerforming'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Top Performing</button>
                            <button onClick={() => setCurrentTab('lowPerforming')} className={`whitespace-nowrap w-10 lg:ease-in-out duration-500 shadow rounded ${currentTab === 'lowPerforming'? 'bg-purple text-white' : 'bg-white text-black'} text-sm p-2 cursor-pointer font-medium hover:text-white hover:bg-purple lg:ease-in-out duration-300 w-44 outline-none`}>Low Performing</button>
                        </div>
                    </div>
