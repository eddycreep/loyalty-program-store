...
import { CreateUser, User, UserRole } from '@/modules/types/user/user-types';
...
export function EditUser({ onClose, selectedUser, onSuccess }: any) {
    ...
    const updateUser = async () => {
        try {
            ...
            console.log('The User has been updated:', response)
    ...
    useEffect(() => {
        if (selectedUser && selectedUser.uid) {
            setCurrentUser({
                ...
                id_no: selectedUser.id_no || '',
                emp_name: selectedUser.emp_name || '',
                emp_surname: selectedUser.emp_surname || '',
                role: selectedUser.role || '',
                organisation: selectedUser.organisation || '',
                branch: selectedUser.branch || ''
            });
        }
    }, [selectedUser]); // Added selectedBranch to dependency array
                ...
                <Card className="w-full max-w-[95vw] md:max-w-[600px] max-h-[90vh] overflow-y-auto">
                    ...
                    <CardHeader>
                        ...
                        <CardDescription className="text-xs sm:text-sm">
                            Edit the user by filling in the required information below
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-4">
                                ...
                                <Button onClick={updateUser} className="bg-green hover:bg-emerald-300 text-white">
                                    Update
                                </Button>
                            </div>
                        </div>
