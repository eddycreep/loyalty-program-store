...
export const AddRewards = ({ onClose }: Props) => {
        ...
        <div className='flex gap-2 pt-8 pr-2'>
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-lg sm:max-w-[600px] w-full">
                        ...
                        <div className="text-xl font-semibold">Add Reward</div>
                        ...
                        <button onClick={ updateReward  } className="bg-black text-white p-2 w-full rounded-lg hover:bg-red">
                            Save
                        </button>
                    </div>
                </div>
