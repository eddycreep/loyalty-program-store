    ...
    <Card data-chart={id} className="flex flex-col">
      ...
      <CardHeader className="flex-row items-start space-y-0 pb-0">
        <div className="grid gap-1">
          <h5 className="text-black font-bold text-md">Top Redeemed Products</h5>
          <p className="text-gray-400 text-sm">Total Redemption for Top Redeemed Products</p>
        </div>
      ...
      <CardFooter className="flex-col items-center gap-2 text-sm">
        <div className="flex items-center justify-center gap-2 font-medium">
          <span className="text-black font-bold text-md">Top Redeemed Products</span>
