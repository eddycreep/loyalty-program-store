                ...
                <Table className="w-full border border-gray-200 rounded-lg">
                  ...
                  <TableBody>
                    {tiersData.map((tier, index) => (
                      <TableRow key={tier.tier} className="text-gray-600">
                        ...
                        <TableCell className="py-4 text-center text-gray-600">{tier.eligibility}</TableCell>
                        <TableCell className="py-4 text-left text-gray-600">{tier.discounts}</TableCell>
                        <TableCell className="py-4 text-left text-gray-600">{tier.rewards}</TableCell>
