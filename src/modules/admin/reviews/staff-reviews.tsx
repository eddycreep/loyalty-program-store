...
export const StaffReviews = () => {
  ...
  return (
    <div className="h-screen px-2 mb-56">
      <div>
        <h2 className="text-2xl text-center mb-4 font-bold text-gray-500">Customer Staff Reviews</h2>
        <SuccessCard />
        
        <div className="pt-10">
          <h5 className="text-xl text-gray-500">Low Staff Rating Reviews</h5>
          {renderReviews(lowRatingReviews)}
        </div>

        <div className="pt-10">
          <h5 className="text-xl text-gray-500">Fair Staff Rating Reviews</h5>
          {renderReviews(fairRatingReviews)}
        </div>

        <div className="pt-10">
          <h5 className="text-xl text-gray-500">High Staff Rating Reviews</h5>
